...
<html lang="en">
  <head>
    ...
    <meta name="author" content="SmartChat, Subhajit Mondal">
    ...
    <?php
  $title = "Forgot password • SmartChat";
  $keywords = "SmartChat, Share and capture world's moments, share, capture, share, login, forgot password";
